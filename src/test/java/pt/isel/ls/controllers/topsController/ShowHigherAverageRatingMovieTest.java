 ...
 * Test request: GET /tops/ratings/higher/average
 * ShowHigherAverageRatingMovie is the command responsible.
 */
public class ShowHigherAverageRatingMovieTest extends BaseDatabaseTest {
	...
	public void testCommandWithMultipleMoviesAndMultipleRatings() throws SQLException, RequestException {
		...
		//execute command
		String[] ratingArgs = {"GET", "/tops/ratings/higher/average","", ""};
